-- Create table for ID cards (member data)
...
INSERT INTO public.id_cards (
  name, membership_id, position, chapter, local_government, issued_at, expires_at, barcode, status
) VALUES (
  'Jane Doe', 'RHOPEE-MEM-AKS-0001', 'Member', 'AKWA IBOM STATE CHAPTER', 'Uyo', '2026-07-01', '2027-07-01', 'RHOPEE-MEM-AKS-123456', 'Verified Member'
);
...
SELECT id, name, membership_id, chapter, status
...
SELECT name, membership_id, chapter, status
FROM public.id_cards
WHERE barcode = 'RHOPEE-MEM-AKS-123456'
LIMIT 1;
