...
export async function downloadExamCertificate(result, displayName) {
  ...
  context.fillText(certificateName.toUpperCase(), 576, 335);
  context.font = '15px Georgia';
  context.fillText(certificateNumber, 165, 469);
  context.fillText(issueDate, 165, 576);
  context.font = '12px Georgia';
  context.fillText(result.certificate_course || 'Professional Web Development', 175, 408);
